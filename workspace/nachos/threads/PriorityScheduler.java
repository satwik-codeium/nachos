...
public class PriorityScheduler extends Scheduler {
	...
	protected ThreadState pickNextThread() {
		...
		if (nextThread == null || state.getEffectivePriority() > nextThread.getEffectivePriority()) {
		    nextThread = state;
		}
	    }
	    return nextThread;
	...
	public int getEffectivePriority() {
		...
		for (PriorityQueue queue : acquiredQueues) {
		    for (ThreadState state : queue.waitQueue) {
			effectivePriority = Math.max(effectivePriority, state.getEffectivePriority());
		    }
		}
	    }
	...
	public void setPriority(int priority) {
	    ...
	    effectivePriority = -1;
	    if (waitingQueue != null) waitingQueue.updateEffectivePriority();
	}
	 ...
	 */
	public void acquire(PriorityQueue queue) {
	    acquiredQueues.add(queue);
