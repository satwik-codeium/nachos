...
public class KThread {
    ...
    /**
     * Wait for this thread to finish. It can only be called once.
     */
    private boolean hasJoined = false; // To ensure join() is called only once
    ...
    public void join() {
        ...
        try {
            if (this == currentThread) {
                return; // A thread cannot join itself
            }
            if (hasJoined) {
                return; // Join can only be called once
            }
            hasJoined = true;
